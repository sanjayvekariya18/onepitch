    ...
    <div :class="{spinner: loading}">
        ...
        <div v-show="!loading">
            ...
            <div class="row">
                ...
                <div class="col s12">
                    <datatable title="Active Journalist (last login)" :columns="columns" :rows="rows"
...
<script type="text/babel">
  ...
  export default {
    name: 'ActiveJournalistLastLogin',
    components: {
      Preloader,
      LineChart,
      BarChart,
    ...
    data () {
      return {
        ...
        datacollection: null,
        showGraph: 1,
        titleGraph: 'Active Journalist Login',
        options: {
          responsive: true,
        ...
        columns: [
          ...
          { id: 3, label: 'Email Address', field: 'email', numeric: false, html: false, width: 'auto' },
          { id: 4, label: 'Last Login', field: 'last_login', numeric: false, html: false, width: 'auto' }
        ],
      }
    },
    watch: {
    ...
    methods: {
      ...
      getData: function (filters) {
        this.loading = true
        this.$http.get(laroute.route('admin.reports.journalists.last-login', filters))
          .then(response => {
            let activeJournalistLogin = response.data.activeJournalistLogin
            this.rows = activeJournalistLogin
            this.loading = false
            ...
            dataGraph.users = activeJournalistLogin.length
