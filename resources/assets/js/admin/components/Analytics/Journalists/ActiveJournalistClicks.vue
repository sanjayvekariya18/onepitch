    ...
    <div :class="{spinner: loading}">
        ...
        <div v-show="!loading">
            ...
            <div class="row">
                ...
                <div class="col s12">
                    <datatable v-if="!loading" title="Active Journalist (clicks)" :columns="columns" :rows="rows"
  ...
  export default {
    ...
    data () {
      return {
        ...
        datacollection: null,
        showGraph: 1,
        titleGraph: 'Active Journalists Clicks',
        options: {
          responsive: true,
        ...
        columns: [
          ...
          { id: 4, label: 'Full Name', field: 'full_name', numeric: false, html: false, width: 'auto' },
          { id: 5, label: 'Email', field: 'email', numeric: false, html: false, width: 'auto' },
          { id: 6, label: 'Clicks Count', field: 'clicks_count', numeric: true, html: false, width: 'auto' },
          { id: 7, label: 'Last Click', field: 'last_click', numeric: false, html: false, width: 'auto' }
        ],
      }
    },
    watch: {
    ...
    methods: {
      ...
      getData: function (filters) {
        this.loading = true
        this.$http.get(laroute.route('admin.reports.journalists.pitch-clicks', filters))
          .then(response => {
            var activeJournalistClicks = response.data.activeJournalistClicks
            this.rows = activeJournalistClicks
            this.loading = false
            ...
            activeJournalistClicks.forEach(function (value) {
              ...
              if (dataGraph.clicks.indexOf(value.clicks_count) == -1) {
                dataGraph.clicks.push(value.clicks_count)
              }
            })
          ...
          datasets: [
            {
              ...
              lineTension: 0.1,
              fill: false,
              data: [dataGraph.users.length, dataGraph.pitches.length, dataGraph.clicks.length]
            },
          ]
        }
      },
