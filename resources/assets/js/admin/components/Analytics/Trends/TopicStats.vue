<template>
    <div :class="{spinner: loading}">
        ...
        <div v-show="!loading">
            ...
            <div class="row">
                <div class="col s12">
                    <datatable title="Topic Stats" :columns="columns" :rows="rows"
...
<script type="text/babel">
  ...
  export default {
    ...
    methods: {
      ...
      getData: function () {
        this.loading = true
        this.$http.get(laroute.route('admin.reports.trends.topic-stats'))
          .then(response => {
            ...
            topics.forEach(function (value) {
              dataGraph.titles = topics.length
      ...
      fillLineChart (dataGraph) {
        this.datacollection = {
          labels: ['topics', 'pitches submited', 'pitches drafted', 'pitches sent', 'pitches rejected', 'responses', 'journalist subscriptions', 'publicist subscriptions'],
          datasets: [
            {
              label: 'Data Graph',
              borderColor: '#f87979',
