    ...
    <div id="modal-add-industry" class="modal" :class="{open: isOpened}">
        <div class="modal-content">
            ...
            <div class="row">
                ...
                <input type="hidden" v-model="industry.id">
            </div>
        </div>
        <div class="modal-footer">
            <button v-on:click="trigger('del')" class="btn btn-danger">DELETE INDUSTRY</button>
    ...
    export default {
        ...
        methods: {
            ...
            editIndustry: function () {
                this.$http.put(laroute.route('admin.rest.industries.resource', { industry: this.industry.id }), this.industry )
                    .then((response) => {
            ...
            deleteIndustry: function () {
                this.$http.delete(laroute.route('admin.rest.industries.resource', { industry: this.industry.id }))
                    .then((response) => {
                        this.$parent.getIndustries();
                        this.close();
                    }).catch((e) => {
