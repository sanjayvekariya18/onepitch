<template>
    <div class="list-items inquiries published" :class="{spinner: loading}">
        <preloader v-if="loading"></preloader>
        <div v-show="!loading">
            <div class="table-header">
                <div class="row">
                    <div class="col title">Published Inquiries - {{ inquiries.length }}</div>
                    <div class="col sorter right-align">
                        <date-range-component v-bind:publishedPitches="inquiries" @filtered-by-date="filteredInquiries"></date-range-component>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    export default {
        ...
        methods : {
            getInquiries: function () {
                this.loading = true;
                this.$http.get(laroute.route('admin.rest.inquiries.published', {sort: 'desc'}))
                    .then(response => {
