<template>
    <div class="list-items pitches rejected" :class="{spinner: loading}">
        <preloader v-if="loading"></preloader>
        <div v-show="!loading">
            <div class="table-header">
                <div class="row">
                    <div class="col title">Rejected Pitches - {{ pitches.length }}</div>
...
<script type="text/babel">
    ...
    export default {
        ...
        methods : {
            getPitches: function () {
                this.loading = true;
                this.$http.get(laroute.route('admin.rest.pitches.rejected', {sort: 'desc'}))
                    .then(response => {
