<template>
    <div id="modal-edit-summary" class="modal" :class="{open: isOpened}" v-if="inquiry.subject">
        <div class="modal-content">
            <h4>Edit Summary Information of this Inquiry</h4>
            <div class="row">
                ...
                <div class="form-group col-sm-6">
                    <input type="text" class="form-control" name="company" placeholder="What brand are you inquirying for?"
                           v-model="summary.company" required>
                    <label>What brand are you inquirying for?</label>
                </div>
...
<script type="text/babel">
    ...
    export default {
        ...
        props: ['summaryInquiry'],
        computed: {
            inquiry: function () {
                return this.summaryInquiry;
            }
        },
        watch: {
        ...
        methods: {
            ...
            saveSummary : function() {
                ...
                this.$http.put(laroute.route('admin.rest.inquiries.resource.summary-for-inquiry', {inquiry: this.inquiry.id}), {summaries: summariesCollection.all()}).then((response) => {
