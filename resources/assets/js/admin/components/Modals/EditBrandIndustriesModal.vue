<template>
    <div id="modal-edit-industries" class="modal" :class="{open: isOpened}" v-if="brand.tags.industries">
        <div class="modal-content">
            <h4>Edit Industries Assigned to this Brand</h4>
...
<script type="text/babel">
    ...
    export default {
        mounted () {
            this.getIndustries();
            let ind = collect(this.brand.tags.industries);
        ...
        methods: {
            ...
            saveIndustries : function() {
                this.$http.put(laroute.route('admin.rest.brands.resource.industries', {brand: this.brand.id}), {ids: this.ids.all()}).then((response) => {
