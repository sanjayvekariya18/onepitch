<template>
    <div id="modal-edit-industries" class="modal" :class="{open: isOpened}" v-if="pitch.industries">
        <div class="modal-content">
            <h4>Edit Industries Assigned to this Pitch</h4>
...
<script type="text/babel">
    ...
    export default {
        mounted () {
            this.getIndustries();
            let ind = collect(this.pitch.industries);
        ...
        methods: {
            ...
            saveIndustries : function() {
                this.$http.put(laroute.route('admin.rest.pitches.resource.industries', {pitch: this.pitch.id}), {ids: this.ids.all()}).then((response) => {
