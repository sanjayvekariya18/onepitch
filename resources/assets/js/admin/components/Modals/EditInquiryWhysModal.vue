<template>
    <div id="modal-edit-whys" class="modal" :class="{open: isOpened}" v-if="inquiry.subject">
        <div class="modal-content">
            <h4>Edit Wants Information of this Inquiry</h4>
            <div class="row">
                <div class="col-sm-12 textarea-bullet one-line" v-for="why in whys">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" v-model="why.why" @keyup="validateWhy" placeholder="Describe want in a bullet here. You have 280 characters."></textarea>
                        <label>Describe want in a bullet here. You have 280 characters.</label>
    ...
    export default {
        ...
        methods: {
            ...
            saveWhys: function() {
                ...
                this.$http.put(laroute.route('admin.rest.inquiries.resource.whys-for-inquiry', {inquiry: this.inquiry.id}), {whys: whysCollection.all()}).then((response) => {
