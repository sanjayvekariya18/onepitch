<template>
    <div id="modal-edit-whats" class="modal" :class="{open: isOpened}" v-if="pitch.subject">
        <div class="modal-content">
            <h4>Edit What Information of this Pitch</h4>
            <div class="row">
    ...
    export default {
        ...
        methods: {
            ...
            saveWhats: function() {
                ...
                this.$http.put(laroute.route('admin.rest.pitches.resource.whats-for-pitch', {pitch: this.pitch.id}), {whats: whatsCollection.all()}).then((response) => {
