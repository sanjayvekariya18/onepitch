<template>
    <div id="modal-stop-inquiry" class="modal" :class="{open: isOpened}">
        <div class="modal-content">
            <h4>Stop Send</h4>
            <p>Are you sure you want to stop this inquiry from being sent? This inquiry will go into Rejected Inquiries, and can be re-accepted at any time.</p>
        </div>
