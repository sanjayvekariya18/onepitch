<template>
    <div id="modal-edit-files" class="modal" :class="{open: isOpened}" v-if="pitch.subject">
        <div class="modal-content">
            <h4>Edit Files Information of this Pitch</h4>
            <div class="row">
                <div class="form-group col-sm-10" v-for="file in files">
                    <input type="text" :id="'file-'+file.id" class="form-control" name="subject" placeholder="Change the name of the file to be displayed to the Journalist"
    ...
    export default {
        ...
        methods: {
            ...
            saveFiles: function() {
                ...
                this.$http.put(laroute.route('admin.rest.pitches.resource.files-for-pitch', {pitch: this.pitch.id}), {files: filesCollection.all(), deletedFiles: deletedFilesCollection.all()}).then((response) => {
