...
@section('content')
    <table border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0;max-width: 680px;width: 100%;" width="100%">
        @component('emails.parts.of-page.head')
            @slot('title')
                More good news, savvy journalist.
            @endslot
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0" width="100%">
                    ...
                    <tr>
                        <td style="font-size: 15px;line-height: 1.6;text-align: left;color: #414745;font-family: sans-serif;" height="24">
                            Brand: {{ $inquiry->company ? $inquiry->company : 'N/A' }}
                        </td>
                    </tr>
                    @if($inquiry->website)
                        <tr>
        ...
        {{--<a style="font-size: 14px;font-weight: bold;line-height: 1.14;letter-spacing: 0.9px;color: #414745;text-decoration: underline;font-family: sans-serif" href="mailto:{{ $inquiry->user->email }}">FORWARD PITCH</a>--}}
        {{--</td>--}}
        {{--<td width="40"></td>--}}
        {{--</tr>--}}
        <tr>
