...
<div class="wizard-progress-wrap">
    <div class="wizard-progress">
        ...
        <div class="wizard-element {{ $step == 'what' ? 'current' : '' }}" onclick="window.location='{{ route('pitch_what') }}'">
            <div class="icon">
        ...
        <div class="wizard-element {{ $step == 'why' ? 'current' : '' }}" onclick="window.location='{{ route('pitch_why') }}'">
            <div class="icon">
            ...
            <div class="title">What & Why</div>
        </div>

        <div class="wizard-line {{ isset($steps[$step]) && $steps[$step] > $steps['why'] ? 'done' : '' }}"></div>

        <div class="wizard-element {{ $step == 'where' ? 'current' : '' }}" onclick="window.location='{{ route('pitch_where') }}'">
            <div class="icon">
