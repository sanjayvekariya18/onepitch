    ...
    <div class="faq_page referral_page featured-post">
        <div class="page_header">
            ...
            <div class="bottom_text">
                How Botmetric Cut Through The AI Clutter
            </div>
        ...
        <div class="page_content">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="step_block">
                                ...
                                <div class="bottom_text">
                                    Identifies WHAT is being pitched
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="step_block">
                                ...
                                <div class="bottom_text">
                                    Identifies industry problem and explains in minor detail how Botmetric helps.
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="step_block">
                                ...
                                <div class="bottom_text">
                                    Explains WHY technology is implemented and forecasts future trends
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="disco_wrap">
                <div class="img_wrap">
                    {{HTML::image('/images/featured-pitch-december.png', '', ['class' => 'desktop'])}}
                    {{HTML::image('/images/featured-pitch-december.png', '', ['class' => 'mobile'])}}
                </div>
            </div>
