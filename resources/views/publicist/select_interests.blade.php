    ...
    <div class="container">
        <div class="content content-area">
            <h2 class="text-center" id="page-head">
                @if (!$edit)
                    First, what industry does your client, or brand, cover?
                @else
                    What industry does your client, or brand, cover?
                @endif
            </h2>
            ...
            <form action="" method="POST" class="industries-form">
                <div class="btn-done-wrapper hidden">
                    <button type="submit" class="btn btn-ylw-done">
                        Done with interests<i class="material-icons">arrow_forward</i>
                    </button>
                </div>
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            <div class="input-group white-input">
                                ...
                                <div class="input-group-addon"><img src="/img/icon-search.svg" alt=""></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="industries-wrapper">
                ...
                <div class="showing-count-bottom m-b-64">
                    Showing
                    <span class="count industries-showing"></span>/<span class="industries-total"></span> Industries
                </div>
                <div class="text-center">
                    <a href="javascript:void(0);"
                       onclick="common.loadMoreIndustries($('#search-industry'), $('.industries-wrapper .industries'),
                       {{ $user->id }});" class="btn btn-white-ylw btn-submit load-more-industries m-b-64">
                        Load More
                    </a>
                </div>
            </div>
    ...
    <script>
        $(function(){
            ...
            $('#check_all').click(function(){
               common.selectAllIndustries($(this));
            });
        });

        function industryAddCallback(tags) {
            if($('.industries-total').html() != ''){

                var totalIndustries = parseInt($('.industries-total').html());
                var selectedIndustries = $(tags+' .tag').length;

                if(selectedIndustries < totalIndustries){
            ...
            if ($(tags+' .tag').length) {
                ...
                @if (!$edit)
                $('#page-head').text('What other industries does your client, or brand, cover?');
                @endif
            } else {
                $('.industries-form .btn-done-wrapper').addClass('hidden');

                @if (!$edit)
                $('#page-head').text('First, what industries does your client, or brand, cover?');
                @endif
            }
            ...
            var tour = new Tour({
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        content: "Select at least one industry, related to the brand/client you represent.<br><br>You MUST select one industry to proceed to the next step.",
                        backdropPadding: {
                            top: 8,
                            left: 10,
                            bottom: 0,
                    ...
                    },
                    {
                        ...
                        content: "Select at least one topic related to your brand/client you represent.<br><br>You MUST select one topic to proceed to next step.",
                        template: `<div class='popover tour'>
                            <div class='arrow'></div>
                            <h3 class='popover-title'></h3>
                            <div class='popover-content'></div>
                    ...
                    },
                    {
                        ...
                        content: "Click this button to receive a Journalist inquiry for ALL topics listed related to the industry selected on the previous page."
                    },
                    {
                        element: "#add-topics",
                        placement: "top",
                        title: "Complete Your Subscriptions",
                        content: "Click this button to complete and confirm your inquiry subscriptions.<br><br>Note: you can add more subscriptions on the next page by clicking NEXT.",
                        template: `<div class='popover tour'>
                            <div class='arrow'></div>
                            <h3 class='popover-title'></h3>
                            <div class='popover-content'></div>
                    ...
                    },
                    {
                        ...
                        placement: "left",
                        title: "Submit Inquiry Subscription",
                        content: "Click this button to submit and confirm your subscription to Journalist inquiry's.",
                        template: `<div class='popover tour'>
                            <div class='arrow'></div>
                            <h3 class='popover-title'></h3>
                            <div class='popover-content'></div>
